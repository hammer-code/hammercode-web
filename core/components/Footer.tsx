    ...
    <footer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="px-4">
          ...
          <ul>
            <li className="mb-2"><Link className="link" href="/">Home</Link></li>
            <li className="mb-2"><Link className="link" href="/about">Tentang Kami</Link></li>
          </ul>
        </div>
        <div className="px-4">
          ...
          <ul>
            ...
            <li className="mb-2"><a className="link" target="_blank" href="https://github.com/hammer-code">Github</a></li>
          </ul>
        </div>
        <div className="px-4">
        <h2 className="text-lg font-bold mb-4">Kontak</h2>
          ...
          <p><a href="https://goo.gl/maps/6BS2dTYcE7wws94w6" target="_blank">Jl. Lagarutu No. 28, Tanamodindi, Palu</a></p>
        </div>
      </div>
      </div>
      </div>
