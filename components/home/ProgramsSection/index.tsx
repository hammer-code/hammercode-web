        ...
        <div className="py-12">
          <div className="px-6">
            ...
            <h2 className="text-3xl font-bold mb-8">
              Kegiatan Bermanfaat dan Gratis*
            </h2>
          </div>
          <div className="flex flex-col md:flex-row">
            <div className={style["program-card-wrapper"]}>
              <div className={style["program-card"]}>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  ...
                  <i>internship</i> dan <i>full-time job</i>
                </p>
                <a
                  href={whatsappLink}
                  target="_blank"
            ...
            <div className={style["program-card-wrapper"]}>
              <div className={style["program-card"]}>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  ...
                  <strong>web</strong>, <strong>mobile apps</strong> hingga{" "}
                  <strong>data</strong>. Tingakat materi yang disampaikan
                  bervariasi, mulai dari <i>beginner</i> hingga <i>advanced</i>.
                </p>
                <a
                  href={whatsappLink}
                  target="_blank"
            ...
            <div className={style["program-card-wrapper"]}>
              <div className={style["program-card"]}>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Acara <i>knowledge-sharing</i> bulanan yang diisi oleh
                  pemateri dari pelaku industri dan teman-teman komunitas.
                </p>
                <a
